...
REWARD_IMG=$HF_HOME/hub/models--Qwen--Qwen3-VL-8B-Instruct/snapshots/0c351dd01ed87e9c1b53cbc748cba10e6187ff3b

export VERL_VLLM_RPC_TIMEOUT_S=600

CUDA_VISIBLE_DEVICES=0,1,2,3,4,5 bash examples/flowgrpo_trainer/run_flowgrpo_nocfg.sh \
  trainer.n_gpus_per_node=4 \
  trainer.logger='["console","wandb"]' \
  trainer.default_local_dir=$CKP_DIR \
  ...
  reward.reward_model.rollout.max_num_seqs=1024 \
